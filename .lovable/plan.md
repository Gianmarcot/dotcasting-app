...
2. **Modale di ritaglio con due proporzioni.** La modale "Ritaglia immagine" avrà due tab: `Copertina 2:3` e `Avatar 1:1`. Ogni tab parte dal ritaglio già salvato (se esiste) o da un ritaglio centrato di default. Si conferma con un unico pulsante: vengono salvati i ritagli modificati.
3. **Anteprime nella galleria.** Sulla card della foto, nella modale "Fotografie", si vedrà l'indicazione dei ritagli presenti (2:3 e 1:1) e l'azione di ritaglio aprirà direttamente la modale a due tab.
4. **Foto profilo diversa dalla copertina.** La prima foto della categoria "Foto principali" continua a definire la foto profilo, ma userà il ritaglio 1:1 se presente; galleria, invii cliente e PDF continuano a usare il 2:3. Se il ritaglio 1:1 non è stato fatto, si usa un quadrato centrato automatico, così l'avatar resta sempre corretto.
