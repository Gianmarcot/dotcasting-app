...
export const NotificationDetailView = ({
  ...
  const action = getNotificationActionHref(notification, areaPath);
      ...
      <div className="dc-card p-8 space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <h1 className="font-display uppercase tracking-wide text-2xl md:text-3xl text-foreground mt-1">
              {title}
            </h1>
